            ...
            <div className="container px-4">
              ...
              "
                        >
                            ...
                            {/* add form that has name, email, phone */}
                            <form>
                                <div class="mb-[22px]">
                                    <label htmlFor="name" className="mb-4 block text-base text-dark dark:text-white">Name</label>
                                    <Input
                                        type="text"
                                        name="name"
                                        id="name"
                                ...
                                <div class="mb-[22px]">
                                    <label htmlFor="email" className="mb-4 block text-base text-dark dark:text-white">Email</label>
                                    <Input
                                        type="text"
                                        name="email"
                                        id="email"
                                ...
                                <div class="mb-[22px]">
                                    <label htmlFor="name" className="mb-4 block text-base text-dark dark:text-white">Message</label>
                                    <Textarea
                                        type="textarea"
                                        name="message"
                                        id="message"
                                ...
                                <div class="mb-8">
                                    <button
                                        type="submit"
                                        className="w-full py-3 text-base font-semibold text-white bg-primary rounded-lg hover:bg-primary-2 focus:outline-none"
                                    >
                                        Send Message
                                    </button>
                                </div>
