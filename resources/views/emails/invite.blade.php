      ...
      <tr>
        <td class="w-[552px] max-w-full">
          ...
          <table class="w-full" cellpadding="0" cellspacing="0" role="none">
            <tr>
              <td class="p-12 sm:px-6 text-base text-gray-900 bg-white rounded shadow-sm">
                <h1 class="m-0 mb-6 text-2xl sm:leading-8 text-black font-semibold">
                  Hello {{ $name }},
                </h1>

                <p class="m-0 leading-6">
                  You've been invited to create your {{ $type}} profile on the Ball Morese Lowe BOIR Application.
                  <br>
                  <br>
                  Please click the button below to begin the process.  You will <span class="font-bold">need the following information</span> to complete your profile:
                  <br>
                  </p><ul class="list-disc">
                    <li>A FinCEN ID</li>
                        

<div role="separator" class="false bg-slate-200" style="height: 1px; line-height: 1px; margin: 0; margin-top: 12px; margin-bottom: 12px">&zwj;</div>
...
<div role="separator" class="false bg-slate-200" style="height: 1px; line-height: 1px; margin: 0; margin-top: 12px; margin-bottom: 12px">&zwj;</div>
                  ...
                  <br>
                  The link below will expire at <span class="font-bold text-blue-700"> {{ $expiration }} </span>. Please click the button below to begin.
                <p></p>
...
<div>
  <a href="{{$inviteURL}}" class="inline-block py-4 px-6 text-base leading-none font-semibold rounded text-slate-50 bg-indigo-700 [text-decoration:none]">
    <!--[if mso]>
...
<div role="separator" class="false bg-slate-200" style="height: 1px; line-height: 1px; margin: 0; margin-top: 32px; margin-bottom: 32px">&zwj;</div>
                ...
                <p class="m-0">
                  If you didn't request an invitation to this platform, you can safely ignore this email.
                  <br>
                  <br>
                  Thanks, <br>The Ball Morse Lowe Team
                </p>
              </td>
            </tr>
            <tr role="separator">
